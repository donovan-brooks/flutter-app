...
class DialogPaymentRequestSend extends StatelessWidget {
  const DialogPaymentRequestSend({Key key, this.data}) : super(key: key);
  final Invoice data;
      ...
      child: Column(
        ...
        children: [
          ...
          TextButton(
            ...
            child: Text("View on web",
                style: TextStyle(color: appColor.black, fontSize: 20.h)),
          ),
          WidgetUtil.spaceVertical(10),
          WidgetUtil.horizontalLine1(),
          WidgetUtil.spaceVertical(10),
